...
In this lecture, we will prove that every fdvsp has a basis, and that the cardinality of a basis is an invariant of a fdvsp.
...
# Cardinality of basis is invariant of an fdvsp
