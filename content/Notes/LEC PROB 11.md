...
> > $$
> > Thus, [[LEC PROB 1#Properties of the probability function|we have]] 
> > $$
...
> > $$
> > Now, note that $f-f_{n}\leq f$, and $f$ is integrable. Thus, using [[LEC PROB 10#The dominated convergence theorem|DCT]], we have
> > $$
> > \begin{align}
