...
> [!Theorem]
> A [[LEC DMAT 21#Matchings|matching]] $M$ in a graph $G$ is a maximum matching in $G$ iff $G$ has no $M$-augmenting path.
...
We will now give an alternate proof for [[LEC DMAT 21#Perfect matchings in bipartite graphs|Hall's theorem]].
