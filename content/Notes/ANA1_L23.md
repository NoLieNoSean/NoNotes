...
>$$
>provided the [[ANA1_L10#Definition of limit of a function in R|limit exists]], in which case we say $f$ is *differentiable* at $x$.
...
>$$
>From the [[ANA1_L11#Algebra of limits of functions|algebra of limits]], this is equal to
>$$
...
>**Proof of 1** 
>Follows from the [[ANA1_L11#Algebra of limits of functions|algebra of limits]]. 
>
>**Proof of 2**
