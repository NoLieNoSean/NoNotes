...
> Let $M$ be a $3$-manifold. A surface $S$ in $M$ is **compressible** if wither
...
An orientable irreducible $3$-manifold that contains a proper essential surface is called a **Haken $3$-manifold**. 