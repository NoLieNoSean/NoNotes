...
The proof of this supplied in the reference exemplifies the use of the [[LEC DMAT 16#Template for Proof by Induction on Number of Vertices|template for proof by induction on number of vertices]] from the previous lecture.
