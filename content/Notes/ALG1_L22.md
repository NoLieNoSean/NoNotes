...
> $$
> The standard basis of $V$ is $( \mathbf{v}_{1}, \mathbf{v}_{2}, \mathbf{v}_{3} )\equiv( 1, t, t^{2})$. Applying the [[ALG1_L21#Gram-Schmidt Orthogonalization Process|Gram-Schmidt Orthogonalization Process]], we get 
> $$
> \begin{align} \\
...
> > $$
> > \begin{align}
> > \lVert \mathbf{v}-\mathbf{w} \rVert  & =\left\langle \mathbf{v}- \sum_{i=1}^{k} \lambda_{i}\mathbf{u}_{i}, \mathbf{v}-\sum_{i=1}^{k} \lambda_{i}\mathbf{u}_{i} \right\rangle  \\
