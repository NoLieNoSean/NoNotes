...
\end{align}
$$
where [[LEC PROB 1#Properties of the probability function|these]] properties have been used. A closely related result is $F(x_{0}-)=P(X< x_{0})$:
