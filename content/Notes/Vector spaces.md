...
- Commutativity
- Associativity
- Additive identity: Existence of special vector $\bf{0}$ such that $\bf{v} + \bf{0} = \bf{v}$ for all $\bf{v} \in V$. Note that this does not explicitly require $\mathbf{0}$ to be unique, but forces that to be the case.
