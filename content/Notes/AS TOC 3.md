...
Show that the language of all cyclic permutations of a context free language is context free.
...
![[AS TOC 3 2025-10-05 19.34.21.excalidraw]]
`Figure 1`
...
$$
in $\mathbf{G}'$. Therefore, $w\in L(\mathbf{G}')$. For example, the derivation tree in $\mathbf{G}'$ of $w$ corresponding to the following derivation tree of $\overline{w}$ in $\mathbf{G}$ is given by `Figure 1`:

![[AS TOC 3 2025-10-05 22.06.23.excalidraw]]
