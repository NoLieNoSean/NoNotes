...
> > 
> > $(\impliedby)$ Assume every real valued function on $X$ takes a minimum and maximum value. To show that $X$ is compact, it is [[LEC CAL1 7#Characterization of compact sets|necessary and sufficient]] to show that it is complete and totally bounded.
> > 
