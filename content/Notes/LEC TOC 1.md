...
Alphabet, word/string, language, $\epsilon$, $\Sigma^{*}$, $\emptyset$, decision problem, countably infinite, uncountably infinite, graph, non-determinism
...
_Ignore the words Deterministic / DFA in the following problems._
