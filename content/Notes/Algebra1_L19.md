...
>[!Theorem] Lemma
> The [[Algebra1_L18#Characteristic Polynomial|characteristic Polynomial]] of a linear operator is independent of the basis.
...
> **Proof**
> Let $\lambda_{1}, \lambda_{2}, \dots, \lambda_{n}$ be the distinct eigenvalues. For each eigenvalue $\lambda_{i}$, let $\mathbf{v}_{i}$ be a corresponding eigenvector. [[Algebra1_L17#Eigenvectors with distinct eigenvalues are linearly independent|Then]], $\mathbf{v}_{1}, \mathbf{v}_{2}, \dots, \mathbf{v}_{n}$ are linearly independent. Hence, they form a basis of $V$. ❏
