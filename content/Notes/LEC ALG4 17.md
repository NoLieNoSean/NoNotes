...
> Let $E$ be a field. 
> 1. For a subfield $F\subseteq E$, the **Galois group** of an extension $E/F$ is the set (easily seen to be a subgroup of $\text{Aut}(E)$) of $F$-automorphisms of $E$. Denoted by $\text{Aut}_{F}(E)$ or $\text{Gal}(E/F)$. 
