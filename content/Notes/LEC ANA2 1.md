...
> $$
> Let $\mathscr{l}_{\infty}$ denote $(B(\mathbb{N}), \lVert \cdot \rVert_{\infty})$ (this is the space defined [[LEC ANA1 33#Another perspective on uniform convergence|here]] with $X=\mathbb{N}$, where we have shown that it is a NLS). 
